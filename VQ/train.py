...
class PlusTrainer:
    def __init__(self, config, is_train=True):
        ...
        self.v3_relativity = config.get('v3_relativity', 10)
    ...
    def one_epoch(self, epoch_num, loss_counter: LossCounter, data_loader,
        ...
        for batch_ndx, sample in enumerate(data_loader):
            ...
            v3_loss = cal_v3_loss(e_content, z_content, e_style, relativity=self.v3_relativity) if self.use_v3_loss else {
...
def cal_v3_loss(z_content, e_content, z_style, relativity=10):
